...
public class RedPacket{
    ...
    public RedPacket(Context context, Bitmap originalBitmap, int speed, float size, int viewWidth) {
        //红包的宽度
        width = (int) (originalBitmap.getWidth() * size);
        //红包的高度
        ...
        y = -height;
        //初始化该红包的下落速度
        this.speed = speed + (float) Math.random() * 300;
        //初始化该红包的初始旋转角度
