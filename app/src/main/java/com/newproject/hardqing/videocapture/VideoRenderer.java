...
public class VideoRenderer
    implements Choreographer.FrameCallback, IZegoVideoRenderCallback, IZegoVideoDecodeCallback {
    ...
    public void onVideoRenderCallback2(VideoFrame videoFrame, VideoPixelFormat videoPixelFormat, String streamID) {
        Log.e(TAG,"**** 渲染 callback, " + videoPixelFormat.name());
    ...
    public void onVideoDecodeCallback(EncodedVideoFrame encodedVideoFrame, String streamID) {
        Log.e(TAG,"**** 解码 callback, " + encodedVideoFrame.codecType);
